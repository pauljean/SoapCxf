 ...
 * 2021-02-19T23:13:46.810+01:00
 * Generated source version: 3.4.2
 *
 */
@WebServiceClient(name = "HelloServiceService",
                  wsdlLocation = "file:/F:/0-workspace-java/SoapCxf/SoapWebClient/src/main/resources/wsdl/hello.wsdl",
                  targetNamespace = "http://service.soapwebserver.pauljean.com/")
public class HelloServiceService extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://service.soapwebserver.pauljean.com/", "HelloServiceService");
    public final static QName HelloServicePort = new QName("http://service.soapwebserver.pauljean.com/", "HelloServicePort");
    static {
        URL url = null;
        try {
            url = new URL("file:/F:/0-workspace-java/SoapCxf/SoapWebClient/src/main/resources/wsdl/hello.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(HelloServiceService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:/F:/0-workspace-java/SoapCxf/SoapWebClient/src/main/resources/wsdl/hello.wsdl");
        }
        WSDL_LOCATION = url;
    }
